...
a_46 <- count(df_46$X4.6.server.cloud.processing)
b_46 <- count(df_46$X4.6.parallel.computing)
c_46 <- count(df_46$X4.6.time.series.retrieval)
d_46 <- count(df_46$X4.6.Download.large.data.volumes)
e_46 <- count(df_46$X4.6.standard.data.access)
f_46 <- count(df_46$X4.6.web.applications.visualization)
g_46 <- count(df_46$X4.6.data.discovery)
h_46 <- count(df_46$X4.6.interoperability)
...
# Melt data frame
df_46_perc_melt <- melt(df_46_perc_ord)
df_46_freq_melt <- melt(df_46_freq_ord)
